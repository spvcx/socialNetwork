          ...
          <div class="card text-white p-5 bg-dark">
            <div class="card-body">
              ...
              <form action="reglogin.php" method="post">
                ...
                <div class="form-group"> <label>Подтвердите Пароль</label>
                  <input type="password" name="rpassword" class="form-control" placeholder="Введите пароль"> </div>
                ...
                <button type="submit" name='createaccount' class="btn btn-success">Зарегистрироваться</button>
              </form>
            </div>
          </div>
        </div>
