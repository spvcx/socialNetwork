...

{
	...
	function registerUser()
	{
		...
		*/
		...
		DB::query('INSERT INTO user_info VALUES (\'\',:user_id,:firstname,:lastname,:gender,:relations,:city,:about,:interests,:music,:tvshow,:books,:games,:avatar,:website,:bday,:bmonth,:byear,:groupid)',array(
			':user_id' => $userId,
